...
import { L as Location, c as PlatformLocation, a as LocationStrategy, A as APP_BASE_HREF, P as PathLocationStrategy } from './location-CprIx2Bv.mjs';
import { D as CommonModule, a9 as HashLocationStrategy } from './common_module-D8YipLWl.mjs';
...
class LocationUpgradeModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.4+sha-670dc2a", ngImport: i0, type: LocationUpgradeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.2.4+sha-670dc2a", ngImport: i0, type: LocationUpgradeModule, imports: [CommonModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.2.4+sha-670dc2a", ngImport: i0, type: LocationUpgradeModule, imports: [CommonModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.4+sha-670dc2a", ngImport: i0, type: LocationUpgradeModule, decorators: [{
            type: NgModule,
