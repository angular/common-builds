    ...
    ***************************************************************************** */
    ...
    var ngClassDirectiveDef__POST_R3__ = i0.ɵdefineDirective({
        ...
        hostBindings: function (rf, ctx, elIndex) {
            if (rf & 1 /* Create */) {
                i0.ɵelementStyling(null, null, null, ctx);
            }
            if (rf & 2 /* Update */) {
                i0.ɵelementStylingMap(elIndex, ctx.getValue(), null, ctx);
    ...
    var ngStyleDirectiveDef__POST_R3__ = i0.ɵdefineDirective({
        ...
        hostBindings: function (rf, ctx, elIndex) {
            ...
            if (rf & 2 /* Update */) {
                i0.ɵelementStylingMap(elIndex, null, ctx.getValue(), ctx);
                i0.ɵelementStylingApply(elIndex, ctx);
            }
        }
    });
     ...
     * @publicApi
     */
    var VERSION = new i0.Version('8.0.0-beta.5+42.sha-6ccf743.with-local-changes');
