...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Ue=[Se,Be,Pe,Ie,He,We,Te,Me,Ne,je,Ve];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var qe=function(){function e(e){this.locale=e}return e.prototype.transform=function(t,r,n,u){if(void 0===r&&(r="mediumDate"),null==t||""===t||t!=t)return null;try{return oe(t,r,u||this.locale,n)}catch(t){throw $e(e,t.message)}},e}();qe.decorators=[{type:t.Pipe,args:[{name:"date",pure:!0}]}],qe.ctorParameters=function(){return[{type:String,decorators:[{type:t.Inject,args:[t.LOCALE_ID]}]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(pt=function pt(){}).decorators=[{type:t.NgModule,args:[{declarations:[Ue,Dt],exports:[Ue,Dt],providers:[{provide:ge,useClass:we}]}]}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var ht,dt=new t.Version("11.1.0-next.4+245.sha-d067dc0");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */e.APP_BASE_HREF=v,e.AsyncPipe=Ze,e.CommonModule=pt,e.CurrencyPipe=st,e.DOCUMENT=l,e.DatePipe=qe,e.DecimalPipe=it,e.HashLocationStrategy=b,e.I18nPluralPipe=tt,e.I18nSelectPipe=rt,e.JsonPipe=nt,e.KeyValuePipe=ut,e.LOCATION_INITIALIZED=D,e.Location=_,e.LocationStrategy=p,e.LowerCasePipe=Ke,e.NgClass=Se,e.NgComponentOutlet=Be,e.NgForOf=Pe,e.NgForOfContext=Le,e.NgIf=Ie,e.NgIfContext=ke,e.NgLocaleLocalization=we,e.NgLocalization=ge,e.NgPlural=je,e.NgPluralCase=Ve,e.NgStyle=We,e.NgSwitch=Te,e.NgSwitchCase=Me,e.NgSwitchDefault=Ne,e.NgTemplateOutlet=He,e.PathLocationStrategy=E,e.PercentPipe=at,e.PlatformLocation=c,e.SlicePipe=ft,e.TitleCasePipe=Je,e.UpperCasePipe=Qe,e.VERSION=dt,e.ViewportScroller=ht,e.formatCurrency=Fe,e.formatDate=oe,e.formatNumber=Ee,e.formatPercent=ve,e.getCurrencySymbol=J,e.getLocaleCurrencyCode=function Ct(e){return t.ɵgetLocaleCurrencyCode(e)},e.getLocaleCurrencyName=function Ft(e){return t.ɵfindLocaleData(e)[t.ɵLocaleDataIndex.CurrencyName]||null},e.getLocaleCurrencySymbol=function vt(e){return t.ɵfindLocaleData(e)[t.ɵLocaleDataIndex.CurrencySymbol]||null},e.getLocaleDateFormat=j,e.getLocaleDateTimeFormat=H,e.getLocaleDayNames=N,e.getLocaleDayPeriods=T,e.getLocaleDirection=function Et(e){return t.ɵfindLocaleData(e)[t.ɵLocaleDataIndex.Directionality]},e.getLocaleEraNames=V,e.getLocaleExtraDayPeriodRules=z,e.getLocaleExtraDayPeriods=Z,e.getLocaleFirstDayOfWeek=function bt(e){return t.ɵfindLocaleData(e)[t.ɵLocaleDataIndex.FirstDayOfWeek]},e.getLocaleId=x,e.getLocaleMonthNames=M,e.getLocaleNumberFormat=$,e.getLocaleNumberSymbol=U,e.getLocalePluralCase=G,e.getLocaleTimeFormat=W,e.getLocaleWeekEndRange=function _t(e){return t.ɵfindLocaleData(e)[t.ɵLocaleDataIndex.WeekendRange]},e.getNumberOfCurrencyDigits=Q,e.isPlatformBrowser=function At(e){return"browser"===e},e.isPlatformServer=function wt(e){return"server"===e},e.isPlatformWorkerApp=function St(e){return"browserWorkerApp"===e},e.isPlatformWorkerUi=function Bt(e){return"browserWorkerUi"===e},e.registerLocaleData=
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.ɵBrowserPlatformLocation=h,e.ɵDomAdapter=u,e.ɵNullViewportScroller=mt,e.ɵPLATFORM_BROWSER_ID="browser",e.ɵPLATFORM_SERVER_ID="server",e.ɵPLATFORM_WORKER_APP_ID="browserWorkerApp",e.ɵPLATFORM_WORKER_UI_ID="browserWorkerUi",e.ɵangular_packages_common_common_a=f,e.ɵangular_packages_common_common_b=y,e.ɵangular_packages_common_common_c=A,e.ɵangular_packages_common_common_d=F,e.ɵangular_packages_common_common_e=Ue,e.ɵangular_packages_common_common_f=Dt,e.ɵgetDOM=n,e.ɵparseCookieValue=function Pt(e,t){var r,n;t=encodeURIComponent(t);try{for(var u=a(e.split(";")),o=u.next();!o.done;o=u.next()){var i=o.value,c=i.indexOf("="),l=s(-1==c?[i,""]:[i.slice(0,c),i.slice(c+1)],2),f=l[1];if(l[0].trim()===t)return decodeURIComponent(f)}}catch(e){r={error:e}}finally{try{o&&!o.done&&(n=u.return)&&n.call(u)}finally{if(r)throw r.error}}return null},e.ɵsetRootDomAdapter=function Ot(e){r||(r=e)},Object.defineProperty(e,"__esModule",{value:!0})}));