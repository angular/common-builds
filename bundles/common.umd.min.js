 ...
 * found in the LICENSE file at https://angular.io/license
 */
var USE_V4_PLURALS=new _angular_core.InjectionToken("UseV4Plurals"),NgLocalization=function(){function NgLocalization(){}return NgLocalization}(),NgLocaleLocalization=function(_super){function NgLocaleLocalization(locale,useV4Plurals){var _this=_super.call(this)||this;return _this.locale=locale,_this.useV4Plurals=useV4Plurals,_this}return __extends(NgLocaleLocalization,_super),NgLocaleLocalization.prototype.getPluralCategory=function(value,locale){var plural=this.useV4Plurals?getPluralCase(locale||this.locale,value):getLocalePluralCase(locale||this.locale)(value);switch(plural){case Plural.Zero:return"zero";case Plural.One:return"one";case Plural.Two:return"two";case Plural.Few:return"few";case Plural.Many:return"many";default:return"other"}},NgLocaleLocalization}(NgLocalization);NgLocaleLocalization.decorators=[{type:_angular_core.Injectable}],NgLocaleLocalization.ctorParameters=function(){return[{type:void 0,decorators:[{type:_angular_core.Inject,args:[_angular_core.LOCALE_ID]}]},{type:void 0,decorators:[{type:_angular_core.Optional},{type:_angular_core.Inject,args:[USE_V4_PLURALS]}]}]};/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
