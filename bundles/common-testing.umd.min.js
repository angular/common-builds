...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */((function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})}))},t.prototype.getState=function(){return this.state},t}();c.ɵfac=function t(n){return new(n||c)(e.ɵɵinject(u,8))},c.ɵprov=e.ɵɵdefineInjectable({token:c,factory:c.ɵfac}),t.MOCK_PLATFORM_LOCATION_CONFIG=u,t.MockLocationStrategy=h,t.MockPlatformLocation=c,t.SpyLocation=s,Object.defineProperty(t,"__esModule",{value:!0})}));