...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})})},t.prototype.getState=function(){return this.state},t.ngInjectableDef=e.ɵɵdefineInjectable({token:t,factory:function t(e){throw new Error("MockPlatformLocation has a constructor which is not compatible with Dependency Injection. It should probably not be @Injectable().")},providedIn:null}),t}();t.SpyLocation=s,t.MockLocationStrategy=a,t.MockPlatformLocation=l,Object.defineProperty(t,"__esModule",{value:!0})});