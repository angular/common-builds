...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})})},t.prototype.getState=function(){return this.state},t.ngFactoryDef=function n(r){return new(r||t)(e.ɵɵinject(c,8))},t.ngInjectableDef=e.ɵɵdefineInjectable({token:t,factory:function(e){return t.ngFactoryDef(e)},providedIn:null}),t}();t.SpyLocation=s,t.MockLocationStrategy=a,t.MOCK_PLATFORM_LOCATION_CONFIG=c,t.MockPlatformLocation=l,Object.defineProperty(t,"__esModule",{value:!0})});