...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})})},t.prototype.getState=function(){return this.state},t.ngInjectableDef=e.ɵɵdefineInjectable({token:t,factory:function n(r){return new(r||t)(e.ɵɵinject(l,8))},providedIn:null}),t}();t.SpyLocation=s,t.MockLocationStrategy=a,t.MOCK_PLATFORM_LOCATION_CONFIG=l,t.MockPlatformLocation=c,Object.defineProperty(t,"__esModule",{value:!0})});