...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})})},t.prototype.getState=function(){return this.state},h([e.Injectable(),(n=e.Optional(),function(t,e){n(t,e,0)}),i("design:paramtypes",[Object])],t)}();t.SpyLocation=a,t.MockLocationStrategy=u,t.MockPlatformLocation=f,Object.defineProperty(t,"__esModule",{value:!0})});