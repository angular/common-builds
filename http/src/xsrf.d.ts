...
export declare class HttpXsrfCookieExtractor implements HttpXsrfTokenExtractor {
    ...
    static ngFactoryDef: i0.ɵɵFactoryDef<HttpXsrfCookieExtractor>;
    static ngInjectableDef: i0.ɵɵInjectableDef<HttpXsrfCookieExtractor>;
}
/**
...
export declare class HttpXsrfInterceptor implements HttpInterceptor {
    ...
    static ngFactoryDef: i0.ɵɵFactoryDef<HttpXsrfInterceptor>;
    static ngInjectableDef: i0.ɵɵInjectableDef<HttpXsrfInterceptor>;
}
