...
export type { HttpDownloadProgressEvent, HttpEvent, HttpFeature, HttpHandlerFn, HttpInterceptor, HttpInterceptorFn, HttpParameterCodec, HttpParamsOptions, HttpProgressEvent, HttpResourceFn, HttpResourceOptions, HttpResourceRef, HttpResourceRequest, HttpSentEvent, HttpTransferCacheOptions, HttpUploadProgressEvent, HttpUserEvent };
