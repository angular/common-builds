...
return 5;
    ...
    globalThis.ng.common.locales['ceb'] = ["ceb",[["a","p"],["AM","PM"],u],[["AM","PM"],u,u],[["D","L","M","M","H","B","S"],["Dom","Lun","Mar","Miy","Huw","Biy","Sab"],["Domingo","Lunes","Martes","Miyerkules","Huwebes","Biyernes","Sabado"],["Dom","Lun","Mar","Miy","Huw","Biy","Sab"]],u,[["E","P","M","A","M","H","H","A","S","O","N","D"],["Ene","Peb","Mar","Abr","May","Hun","Hul","Ago","Set","Okt","Nob","Dis"],["Enero","Pebrero","Marso","Abril","Mayo","Hunyo","Hulyo","Agosto","Setyembre","Oktubre","Nobyembre","Disyembre"]],u,[["BC","AD"],u,["Sa Wala Pa Si Kristo","Anno Domini"]],0,[6,0],["M/d/yy","MMM d, y","MMMM d, y","EEEE, MMMM d, y"],["h:mm a","h:mm:ss a","h:mm:ss a z","h:mm:ss a zzzz"],["{1}, {0}",u,"{1} 'sa' {0}",u],[".",",",";","%","+","-","E","×","‰","∞","NaN",":"],["#,##0.###","#,##0%","¤#,##0.00","#E0"],"PHP","₱","Philippine Piso",{"JPY":["JP¥","¥"],"USD":["US $","$"]},"ltr", plural, []];
  })();
