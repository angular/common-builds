...
var DecimalPipe = /** @class */ (function () {
    ...
    DecimalPipe.ngPipeDef = i0.ɵdefinePipe({ name: "number", type: DecimalPipe, factory: function DecimalPipe_Factory() { return new DecimalPipe(i0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
    return DecimalPipe;
}());
export { DecimalPipe };
/**
...
var PercentPipe = /** @class */ (function () {
    ...
    PercentPipe.ngPipeDef = i0.ɵdefinePipe({ name: "percent", type: PercentPipe, factory: function PercentPipe_Factory() { return new PercentPipe(i0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
    return PercentPipe;
}());
export { PercentPipe };
/**
...
var CurrencyPipe = /** @class */ (function () {
    ...
    CurrencyPipe.ngPipeDef = i0.ɵdefinePipe({ name: "currency", type: CurrencyPipe, factory: function CurrencyPipe_Factory() { return new CurrencyPipe(i0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
    return CurrencyPipe;
}());
export { CurrencyPipe };
