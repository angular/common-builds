...
var Location = /** @class */ (function () {
    ...
    Location.ngInjectableDef = i0.ΔdefineInjectable({ token: Location, factory: function Location_Factory(t) { return new (t || Location)(i0.Δinject(i1.LocationStrategy), i0.Δinject(i2.PlatformLocation)); }, providedIn: null });
    return Location;
}());
export { Location };
