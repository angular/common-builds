...
import { InjectionToken, EventEmitter, Injectable, ΔdefineInjectable, Δinject, ɵsetClassMetadata, Optional, Inject, LOCALE_ID, ɵisListLikeIterable, ɵstringify, IterableDiffers, KeyValueDiffers, ElementRef, Renderer2, ΔdefineDirective, Δstyling, ΔclassMap, ΔstylingApply, Directive, Input, ΔdirectiveInject, ΔProvidersFeature, ΔInheritDefinitionFeature, NgModuleRef, ComponentFactoryResolver, ViewContainerRef, ΔNgOnChangesFeature, isDevMode, TemplateRef, Host, Attribute, ΔinjectAttribute, ΔstyleMap, Pipe, ΔdefinePipe, ɵlooseIdentical, WrappedValue, ɵisPromise, ɵisObservable, ChangeDetectorRef, NgModule, ΔdefineNgModule, ΔdefineInjector, ΔsetNgModuleScope, Version, ErrorHandler } from '@angular/core';
...
/** @nocollapse */ Location.ngInjectableDef = ΔdefineInjectable({ token: Location, factory: function Location_Factory(t) { return new (t || Location)(Δinject(LocationStrategy), Δinject(PlatformLocation)); }, providedIn: null });
